...
public class WheelView extends View {
    ...
    private static final int FUTURE_FLING = 5;
    ...
    public void smoothScroll(ACTION action) {//平滑滚动的实现
        ...
        mFuture = mExecutor.scheduleWithFixedDelay(new SmoothScrollTimerTask(this, mOffset), 0, FUTURE_FLING, TimeUnit.MILLISECONDS);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (dividerType == DividerType.ROUND_RECT) {
            float startX;
            float endX;
...
//            canvas.drawLine(startX, firstLineY, endX, firstLineY, paintIndicator);
//            canvas.drawLine(startX, secondLineY, endX, secondLineY, paintIndicator);
            canvas.drawRoundRect(new RectF(startX, firstLineY, endX, secondLineY), 10, 10, paintIndicator);
